...
namespace TrabalhoES2.Migrations
{
    ...
    [Migration("20250326101145_updateClasseUtilizador")]
    partial class updateClasseUtilizador
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrabalhoES2.Models.Utilizador", b =>
                {
                    ...
                    b.Property<string>("TpUtilizador")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TrabalhoES2.Models.Utilizador", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "IdentityUser")
                        .WithOne()
                        .HasForeignKey("TrabalhoES2.Models.Utilizador", "IdentityUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
